...
export default function BlogPage() {
  ...
  const categories = ['All', 'Email Marketing', 'Copywriting', 'Conversion', 'Strategy', 'Case Studies']
  ...
  const articles = [
    ...
    {
      id: 4,
      title: "The Ultimate Guide to A/B Testing Your Copy",
      excerpt: "Learn how to systematically test and optimize your copy for maximum conversion rates.",
      category: "Strategy",
    ...
    {
      id: 5,
      title: "Landing Page Copy That Converts: 7 Essential Elements",
      excerpt: "The must-have components every high-converting landing page needs to turn visitors into customers.",
      category: "Conversion",
      readTime: "9 min read",
      date: "Dec 5, 2024",
      image: "🚀",
    ...
    {
      id: 7,
      title: "The Art of Storytelling in Sales Copy",
      excerpt: "How to weave compelling narratives that engage emotions and drive purchasing decisions.",
      category: "Copywriting",
    ...
    {
      id: 8,
      title: "Building Trust Through Authentic Copy",
      excerpt: "Strategies to create genuine connections with your audience through honest, transparent messaging.",
      category: "Strategy",
      readTime: "6 min read",
      date: "Nov 28, 2024",
      image: "🤝",
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Expert insights, proven strategies, and actionable tips to elevate your copywriting and email marketing game.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-card via-background to-card">
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Get weekly copywriting tips, email marketing strategies, and exclusive case studies delivered to your inbox.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-lg mx-auto">
              <div className="flex-1 w-full">
                <input
                  ...
                  className="w-full px-4 py-3 bg-input border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-accent focus:border-accent"
                />
              </div>
              <Button
                className="glow-hover electric-gradient text-primary-foreground px-8 py-3 font-semibold whitespace-nowrap"
              >
                Subscribe Now
              </Button>
            </div>
            ...
            <p className="text-sm text-muted-foreground">
              Join 15,000+ copywriters and marketers. Unsubscribe anytime.
            </p>
          </div>
        </div>
      </section>
